...
for i,epoca in enumerate(epocas):
    ...
    np.savez(f'multicapa_onehot_epoca{epocas_acumuladas}.npz', *multicapa_one_hot.get_weights())
    
    # Guardar modelo completo
    multicapa_one_hot.save(f'multicapa_onehot_model_epoca{epocas_acumuladas}.keras')
