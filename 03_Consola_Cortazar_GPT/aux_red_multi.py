...
with open(os.path.join("..", "data", "corpus_todos_los_fuegos.txt"), "r", encoding="utf-8") as f:
...
W1, W2, N, C, eta = cargar_modelo_completo(os.path.join("..", "models", "pesos_cbow_neg_epoca1500_contexto_5.npz"))
if W1 is None:
